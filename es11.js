...
//e(e)			{ if (e) this.$ = e; return this }
  ...
  style(a)		{ if (a) for (const b in a) if (a[b] === void 0) for (const e of this.$all) e.style.removeProperty(b); else if (a.includes('-')) for (const e of this.$all) e.style.setProperty(b, a[b]); else for (const e of this.$all) e.style[a]=a[b]; return this }
